import { AppModule as TileAppModule } from './app.module';
import { AppComponent as TileAppComponent } from './app.component';

const TileExampleConfig = {
  title: 'Tile type',
  component: TileAppComponent,
  debug: true,
  files: [
